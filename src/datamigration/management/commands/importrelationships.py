                ...
                try:
                    ...
                    if row[self.ROW_FIRSTNAME] is not '':
                        ...
                        if row[self.ROW_EMERGENCY] == '1':
                            self.stdout.write(self.style.SUCCESS('Added an emergency Relationship.'))
                            client.emergency_contact = relationship
                            client.emergency_contact_relationship = row[self.ROW_RELATIONSHIP]
                        if row[self.ROW_BILLTO] == '1':
                            self.stdout.write(self.style.SUCCESS('Added a blling Relationship.'))
